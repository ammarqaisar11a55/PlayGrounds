...
int main()
{
    ...
    cout << longestMonotonicSubarray(vector<int>{1, 4, 3, 3, 2}) << endl;
    cout << longestMonotonicSubarray(vector<int>{3, 3, 3, 3}) << endl;
    cout << longestMonotonicSubarray(vector<int>{3, 2, 1}) << endl;
